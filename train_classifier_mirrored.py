...
parser.add_argument('--model_dir', help='', default='./model_dir', type=str)
parser.add_argument('--save_name', help='', default='single-gpu', type=str)
parser.add_argument('--epochs', help='', default=50, type=int)
parser.add_argument('--batch_size_each', help='', default=256, type=int)
...
parser.add_argument('--num_gpus', help='', default=1, type=int)
parser.add_argument('--multi_gpu_option', help='', default=1, type=int)
